...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StardustCoreSdk.SDTokenMintBulkTokenObject();
  });
  ...
  describe('SDTokenMintBulkTokenObject', function() {
    it('should create an instance of SDTokenMintBulkTokenObject', function() {
      // uncomment below and update the code to test SDTokenMintBulkTokenObject
      //var instance = new StardustCoreSdk.SDTokenMintBulkTokenObject();
      //expect(instance).to.be.a(StardustCoreSdk.SDTokenMintBulkTokenObject);
    });
