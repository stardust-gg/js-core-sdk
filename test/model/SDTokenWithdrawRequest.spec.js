...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StardustCoreSdk.SDTokenWithdrawRequest();
  });
  ...
  describe('SDTokenWithdrawRequest', function() {
    it('should create an instance of SDTokenWithdrawRequest', function() {
      // uncomment below and update the code to test SDTokenWithdrawRequest
      //var instance = new StardustCoreSdk.SDTokenWithdrawRequest();
      //expect(instance).to.be.a(StardustCoreSdk.SDTokenWithdrawRequest);
    });
