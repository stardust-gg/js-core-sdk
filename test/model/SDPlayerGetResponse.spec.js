...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StardustCoreSdk.SDPlayerGetResponse();
  });
  ...
  describe('SDPlayerGetResponse', function() {
    it('should create an instance of SDPlayerGetResponse', function() {
      // uncomment below and update the code to test SDPlayerGetResponse
      //var instance = new StardustCoreSdk.SDPlayerGetResponse();
      //expect(instance).to.be.a(StardustCoreSdk.SDPlayerGetResponse);
    });
