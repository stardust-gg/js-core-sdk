...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StardustCoreSdk.SDPlayerGetAllResponse();
  });
  ...
  describe('SDPlayerGetAllResponse', function() {
    it('should create an instance of SDPlayerGetAllResponse', function() {
      // uncomment below and update the code to test SDPlayerGetAllResponse
      //var instance = new StardustCoreSdk.SDPlayerGetAllResponse();
      //expect(instance).to.be.a(StardustCoreSdk.SDPlayerGetAllResponse);
    });
