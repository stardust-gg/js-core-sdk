...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StardustCoreSdk.SDTokenMutateRequest();
  });
  ...
  describe('SDTokenMutateRequest', function() {
    it('should create an instance of SDTokenMutateRequest', function() {
      // uncomment below and update the code to test SDTokenMutateRequest
      //var instance = new StardustCoreSdk.SDTokenMutateRequest();
      //expect(instance).to.be.a(StardustCoreSdk.SDTokenMutateRequest);
    });
