...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StardustCoreSdk.SDTokenMintBulkRequest();
  });
  ...
  describe('SDTokenMintBulkRequest', function() {
    it('should create an instance of SDTokenMintBulkRequest', function() {
      // uncomment below and update the code to test SDTokenMintBulkRequest
      //var instance = new StardustCoreSdk.SDTokenMintBulkRequest();
      //expect(instance).to.be.a(StardustCoreSdk.SDTokenMintBulkRequest);
    });
