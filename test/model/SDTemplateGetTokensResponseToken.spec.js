...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StardustCoreSdk.SDTemplateGetTokensResponseToken();
  });
  ...
  describe('SDTemplateGetTokensResponseToken', function() {
    it('should create an instance of SDTemplateGetTokensResponseToken', function() {
      // uncomment below and update the code to test SDTemplateGetTokensResponseToken
      //var instance = new StardustCoreSdk.SDTemplateGetTokensResponseToken();
      //expect(instance).to.be.a(StardustCoreSdk.SDTemplateGetTokensResponseToken);
    });
