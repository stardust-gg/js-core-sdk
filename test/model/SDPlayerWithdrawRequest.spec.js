...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StardustCoreSdk.SDPlayerWithdrawRequest();
  });
  ...
  describe('SDPlayerWithdrawRequest', function() {
    it('should create an instance of SDPlayerWithdrawRequest', function() {
      // uncomment below and update the code to test SDPlayerWithdrawRequest
      //var instance = new StardustCoreSdk.SDPlayerWithdrawRequest();
      //expect(instance).to.be.a(StardustCoreSdk.SDPlayerWithdrawRequest);
    });
