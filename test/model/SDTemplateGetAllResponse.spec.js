...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StardustCoreSdk.SDTemplateGetAllResponse();
  });
  ...
  describe('SDTemplateGetAllResponse', function() {
    it('should create an instance of SDTemplateGetAllResponse', function() {
      // uncomment below and update the code to test SDTemplateGetAllResponse
      //var instance = new StardustCoreSdk.SDTemplateGetAllResponse();
      //expect(instance).to.be.a(StardustCoreSdk.SDTemplateGetAllResponse);
    });
