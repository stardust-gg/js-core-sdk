...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StardustCoreSdk.SDGameMutateRequest();
  });
  ...
  describe('SDGameMutateRequest', function() {
    it('should create an instance of SDGameMutateRequest', function() {
      // uncomment below and update the code to test SDGameMutateRequest
      //var instance = new StardustCoreSdk.SDGameMutateRequest();
      //expect(instance).to.be.a(StardustCoreSdk.SDGameMutateRequest);
    });
