...
/**
 * The SDTemplateGetResponse model module.
 * @module model/SDTemplateGetResponse
 * @version 0.0.3
 */
class SDTemplateGetResponse {
    /**
     * Constructs a new <code>SDTemplateGetResponse</code>.
     * @alias module:model/SDTemplateGetResponse
     ...
     * @param type {module:model/SDTemplateGetResponse.TypeEnum} 
     * @param props {module:model/SDTemplateGetAllResponseProps} 
     */
    constructor(gameId, id, cap, totalSupply, name, type, props) { 
        
        SDTemplateGetResponse.initialize(this, gameId, id, cap, totalSupply, name, type, props);
    }
    ...
    /**
     * Constructs a <code>SDTemplateGetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SDTemplateGetResponse} obj Optional instance to populate.
     * @return {module:model/SDTemplateGetResponse} The populated <code>SDTemplateGetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SDTemplateGetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>SDTemplateGetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SDTemplateGetResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SDTemplateGetResponse.RequiredProperties) {
            if (!data[property]) {
...
SDTemplateGetResponse.RequiredProperties = ["gameId", "_id", "cap", "totalSupply", "name", "type", "props"];

/**
 * Game ID Number (unsigned 32 bit integer)
 * @member {Number} gameId
 */
SDTemplateGetResponse.prototype['gameId'] = undefined;

/**
 * @member {Number} _id
 */
SDTemplateGetResponse.prototype['_id'] = undefined;

/**
 * u96 Number as String, min: 0, max: 39614081257132168796771975167
 * @member {String} cap
 */
SDTemplateGetResponse.prototype['cap'] = undefined;

/**
 * The type of custom contract bieng used for this template.
 * @member {module:model/SDTemplateGetResponse.ContractTypeEnum} contractType
 */
SDTemplateGetResponse.prototype['contractType'] = undefined;

/**
 * u96 Number as String, min: 0, max: 39614081257132168796771975167
 * @member {String} totalSupply
 */
SDTemplateGetResponse.prototype['totalSupply'] = undefined;

/**
 * The name of the template
 * @member {String} name
 */
SDTemplateGetResponse.prototype['name'] = undefined;

/**
 * @member {module:model/SDTemplateGetResponse.TypeEnum} type
 */
SDTemplateGetResponse.prototype['type'] = undefined;

/**
 * @member {module:model/SDTemplateGetAllResponseProps} props
 */
SDTemplateGetResponse.prototype['props'] = undefined;

/**
 * Returned to marketplaces as contract metadata
 * @member {Object} publicContractMetadata
 */
SDTemplateGetResponse.prototype['publicContractMetadata'] = undefined;

/**
 * Inherited by tokens, and returned to marketplaces as token metadata
 * @member {Object} publicTokenMetadata
 */
SDTemplateGetResponse.prototype['publicTokenMetadata'] = undefined;

/**
 * @member {Array.<module:model/SDGameGetResponseFeesInner>} fees
 */
SDTemplateGetResponse.prototype['fees'] = undefined;
 ...
 * @readonly
 */
SDTemplateGetResponse['ContractTypeEnum'] = {
 ...
 * @readonly
 */
SDTemplateGetResponse['TypeEnum'] = {
...
export default SDTemplateGetResponse;
